...
const LESSON_TITLES: Record<string, Record<string, string>> = {
  ...
  javascript: {
    ...
    'dates': '18. Dates',
    'classes': '19. Classes',
    'this-keyword': '20. The this Keyword',
    'dom': '21. DOM Manipulation',
    'events': '22. Events',
    'es6-features': '23. ES6+ Features',
    'json': '24. JSON',
    'errors': '25. Error Handling',
    'regexp': '26. Regular Expressions',
    'maps': '27. Maps',
    'sets': '28. Sets',
    'async': '29. Async / Await',
    'fetch-api': '30. Fetch API',
    'debugging': '31. Debugging',
    'web-api': '32. Web APIs',
  },
  html: {
